      ...
      <div className="relative w-full max-w-lg rounded-2xl border border-white/10 bg-[#111827] shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
          ...
          <div className="flex-1 flex flex-col p-4 overflow-hidden">
            <div className="relative mb-3">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-xs rounded-xl bg-slate-900 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition"
              />
            </div>
        ...
        {tab === 'group' && (
          <form onSubmit={handleCreateGroup} className="flex-1 flex flex-col p-4 overflow-hidden">
            <div className="space-y-3 mb-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl bg-slate-900 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition"
                />
              </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-1 pr-1 custom-scrollbar border border-white/5 rounded-xl p-2 bg-slate-950/40">
              {loadingUsers ? (
            ...
            <div className="mt-4 pt-3 border-t border-white/10 flex justify-end gap-2">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 text-xs font-semibold rounded-xl text-slate-400 hover:text-white hover:bg-white/10 transition"
              >
                Cancelar
              </button>
              <button
