      ...
      <div className="rounded-[28px] border border-slate-200 dark:border-white/12 bg-white dark:bg-[#0B1020]/72 p-6 shadow-sm dark:shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl transition-all">
        <div className="mb-4 flex items-center justify-between border-b border-slate-200 dark:border-white/8 pb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-card-title font-bold text-slate-900 dark:text-white">Insights da IA</h3>
          </div>
    ...
    <div className="rounded-[28px] border border-slate-200 dark:border-white/12 bg-white dark:bg-[#0B1020]/72 p-6 shadow-sm dark:shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl transition-all">
      ...
      {insights.topComplaint && (
        <div className="mb-3 space-y-1.5 rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-3.5 backdrop-blur-sm">
          ...
          <p className="text-sm text-slate-700 dark:text-[#E5E7EB]">
      ...
      <div className="space-y-2.5">
        {insights.topColab && (
          <div className="flex items-start gap-2.5 rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-3 transition-colors hover:border-emerald-500/30">
            ...
            <p className="text-sm text-slate-700 dark:text-[#E5E7EB]">
              <strong className="text-slate-800 dark:text-slate-100">Destaque:</strong> <strong>{insights.topColab.nome}</strong> foi elogiado(a) em{' '}
        ...
        {insights.worstDay && (
          <div className="flex items-start gap-2.5 rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-3 transition-colors hover:border-amber-500/30">
            ...
            <p className="text-sm text-slate-700 dark:text-[#E5E7EB]">
              <strong className="text-slate-800 dark:text-slate-100">Padrão {insights.worstDay.day}:</strong> Notas dadas às{' '}
        ...
        {insights.taxaResposta > 0 && (
          <div className="flex items-start gap-2.5 rounded-xl border border-cyan-500/20 bg-cyan-500/[0.04] p-3 transition-colors hover:border-cyan-500/30">
            ...
            <p className="text-sm text-slate-700 dark:text-[#E5E7EB]">
              <strong className="text-slate-800 dark:text-slate-100">Taxa de Resposta:</strong> {insights.respondidas} de {insights.totalActive} avaliações respondidas{' '}
