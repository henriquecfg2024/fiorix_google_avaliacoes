...
export function InsightCard() {
  return (
    <div className="space-y-4 rounded-[28px] border border-white/10 bg-[linear-gradient(135deg,rgba(11,16,32,0.98),rgba(6,10,20,0.98))] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl">
      <div className="flex items-center gap-2 text-cyan-300">
        <Bot className="h-5 w-5 text-cyan-300" />
        <h3 className="text-xs font-bold uppercase tracking-[0.22em]">INSIGHTS DA IA</h3>
      </div>

      <div className="space-y-1 rounded-xl border border-amber-500/18 bg-amber-500/[0.05] p-3.5 backdrop-blur-sm">
      ...
      <div className="space-y-2 text-xs">
        <div className="flex items-start gap-2.5 rounded-lg border border-emerald-500/15 bg-emerald-500/[0.04] p-2.5">
        ...
        <div className="flex items-start gap-2.5 rounded-lg border border-amber-500/15 bg-amber-500/[0.04] p-2.5">
        ...
        <div className="flex items-start gap-2.5 rounded-lg border border-rose-500/15 bg-rose-500/[0.04] p-2.5">
        ...
        <div className="flex items-start gap-2.5 rounded-lg border border-cyan-500/15 bg-cyan-500/[0.04] p-2.5">
