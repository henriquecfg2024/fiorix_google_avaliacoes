...
export function DonutChart({ data }: DonutChartProps) {
  ...
  return (
    <div className="flex h-full min-h-[350px] min-w-0 flex-col overflow-hidden rounded-[24px] border border-slate-800/80 bg-[#0B1020]/90 p-6 shadow-sm backdrop-blur-xl">
      <div>
