    ...
    <Card className="rounded-2xl border border-slate-800/80 bg-[#0B1020]/90 p-5 text-slate-800 dark:text-white shadow-sm shadow-sm backdrop-blur-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 dark:text-white/45">
            Data Inicial
          </label>
          <Input 
            type="date" 
            ...
            className="h-10 rounded-xl border border-slate-200 dark:border-white/8 bg-slate-50 dark:bg-[#0C1323] text-slate-900 dark:text-white shadow-xs focus:border-amber-500 focus:ring-0" 
          />
        </div>
