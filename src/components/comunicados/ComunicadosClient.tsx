  ...
  const [comunicados, setComunicados] = useState<ComunicadoItem[]>([
    ...
    },
    {
      ...
      anexos: [
        {
          id: "anx-3",
          nomeOriginal: "Provimento_CNJ_213.pdf",
          tamanhoBytes: 450120,
          url: "#",
        },
      ],
          ...
          {isManager && (
            <Link href="/sistema/pessoas">
              <Button className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:opacity-90 text-white font-bold text-xs gap-1.5 rounded-xl shadow-lg shadow-indigo-500/20">
                ...
                <span>Novo Comunicado (Painel RH)</span>
              </Button>
            </Link>
          )}
        </div>
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="border-white/10 text-slate-300 hover:text-white hover:bg-white/5 text-xs gap-1.5 rounded-xl"
                >
