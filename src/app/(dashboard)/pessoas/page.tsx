...
export default async function PessoasDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070A12] text-slate-800 dark:text-white selection:bg-amber-500/30 transition-colors duration-300 relative overflow-hidden pb-12">
      {/* Background Ambient Glows */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 left-1/2 h-72 w-[44rem] -translate-x-1/2 rounded-full bg-gradient-to-r from-indigo-500/5 via-purple-500/5 to-cyan-500/5 dark:from-indigo-500/12 dark:via-purple-500/10 dark:to-cyan-500/8 blur-3xl" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3 border-b border-slate-200 dark:border-white/6">
          <div>
            <div className="flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400">
              ...
              <span>Pessoas</span>
              <span className="text-slate-400 dark:text-slate-600">/</span>
              <span className="text-indigo-600 dark:text-indigo-400 font-semibold">Minha Central</span>
            </div>
            <div className="flex items-center gap-3 mt-1.5">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
                {saudacao}, {primeiroNome}!
              </h1>
              <span className="rounded-full border border-indigo-500/20 bg-indigo-50 dark:bg-indigo-500/10 px-2.5 py-0.5 font-mono text-[11px] font-semibold text-indigo-700 dark:text-indigo-300">
                MINHA CENTRAL
              </span>
            </div>
        ...
        {isAdmin && (
          <div className="rounded-[24px] border border-slate-800/80 bg-[#0B1020]/90 p-5 shadow-sm shadow-sm backdrop-blur-xl flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200 dark:bg-indigo-500/15 dark:text-indigo-300 dark:border-indigo-500/25 uppercase tracking-wider">
                    {userRole}
                  </span>
                </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Link
                href="/pessoas/ferias"
                className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-xs font-semibold text-slate-700 border border-slate-200 hover:border-slate-300 dark:bg-white/[0.04] dark:hover:bg-white/[0.08] dark:text-slate-200 dark:border-white/10 dark:hover:border-white/20 transition-all flex items-center gap-1.5 shadow-xs"
              >
              ...
              <Link
                ...
                className="px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-xs font-bold text-white shadow-md shadow-indigo-600/20 border border-indigo-400/30 transition-all flex items-center gap-1.5"
              >
