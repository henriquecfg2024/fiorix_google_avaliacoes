      ...
      <main className="relative mx-auto max-w-[1600px] px-4 py-6 lg:px-8 lg:py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 items-stretch">
          ...
          <div className="flex flex-col justify-between rounded-[28px] border border-slate-800/80 bg-[#0B1020]/90 p-6 shadow-sm shadow-sm backdrop-blur-xl transition-all space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-cyan-50 border border-cyan-200 text-cyan-600 dark:bg-gradient-to-br dark:from-cyan-600/20 dark:to-blue-600/20 dark:border-cyan-500/30 dark:text-cyan-400 shadow-sm">
              ...
              <div className="flex items-center gap-1.5 rounded-lg border border-cyan-500/25 bg-cyan-50 dark:bg-cyan-500/10 px-2.5 py-1 text-xs font-mono font-bold text-cyan-700 dark:text-cyan-300">
              ...
              {[
                {
                  ...
                  Icon: Zap,
                  borderClass: 'border-emerald-200 dark:border-emerald-500/25 hover:border-emerald-400 dark:hover:border-emerald-500/40',
                  iconBoxClass: 'bg-emerald-50 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-300',
                  barColor: 'bg-emerald-500',
                ...
                },
                {
                  ...
                  Icon: Clock,
                  borderClass: 'border-amber-200 dark:border-amber-500/25 hover:border-amber-400 dark:hover:border-amber-500/40',
                  iconBoxClass: 'bg-amber-50 text-amber-600 dark:bg-amber-500/15 dark:text-amber-300',
                  barColor: 'bg-amber-400',
                ...
                },
                {
                  ...
                  Icon: Timer,
                  borderClass: 'border-rose-200 dark:border-rose-500/25 hover:border-rose-400 dark:hover:border-rose-500/40',
                  iconBoxClass: 'bg-rose-50 text-rose-600 dark:bg-rose-500/15 dark:text-rose-300',
                  barColor: 'bg-rose-500',
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center justify-between gap-3 rounded-2xl border bg-slate-50 dark:bg-[#070D1E]/90 p-3.5 transition-all shadow-xs ${factor.borderClass}`}
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="space-y-1.5 min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1 h-1.5 overflow-hidden rounded-full bg-slate-200 dark:bg-slate-800/90 shadow-inner">
                            <div
                    ...
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-200/60 dark:bg-white/[0.04] text-slate-500 dark:text-slate-400 transition-colors group-hover:bg-slate-300 dark:group-hover:bg-white/[0.08] group-hover:text-slate-900 dark:group-hover:text-white">
        ...
        >
          <div className="flex flex-col justify-between gap-4 border-b border-white/8 pb-5 md:flex-row md:items-center">
            ...
            <div className="self-start rounded-2xl border border-cyan-500/25 bg-cyan-50 dark:bg-cyan-500/10 p-3 px-6 text-center md:self-auto shadow-xs dark:shadow-[0_10px_30px_rgba(6,182,212,0.15)]">
              <span className="block text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-700 dark:text-cyan-300">
                SCORE GLOBAL DE REPUTAÇÃO
              </span>
              <div className="text-3xl font-black text-cyan-700 dark:text-cyan-300">
                {reputationHealth.scoreGeral} <span className="text-xs font-semibold text-cyan-600 dark:text-cyan-400">pts</span>
              </div>
            </div>
          </div>

          {/* Como é calculado o Score Final */}
          <div className="space-y-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#0B1020]/90 p-5">
            ...
            <p className="text-xs leading-relaxed text-slate-600 dark:text-white/80">
              O score global reflete o desempenho ponderado dos 10 indicadores operacionais avaliados no cartório:
            </p>
            <div className="inline-block rounded-xl border border-slate-200 dark:border-white/12 bg-white dark:bg-white/[0.04] px-4 py-2.5 font-mono text-xs font-bold text-slate-800 dark:text-white">
              Saúde da Reputação = <span className="text-cyan-700 dark:text-cyan-300 text-sm font-black">{reputationHealth.scoreGeral} Pontos</span> ➜{' '}
              <span className="text-emerald-600 dark:text-emerald-400 text-sm font-black">Reputação {reputationHealth.reputacaoLabel}</span>
            </div>
          </div>

          {/* Simulação de Impacto Operacional */}
          <div className="flex flex-col justify-between gap-4 rounded-2xl border border-cyan-200 dark:border-cyan-500/20 bg-gradient-to-r from-cyan-50 via-indigo-50/50 to-transparent dark:from-cyan-950/20 dark:via-indigo-950/20 dark:to-transparent p-5 md:flex-row md:items-center">
            <div className="space-y-1">
              <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-cyan-700 dark:text-cyan-300">
              ...
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">
                ...
                <span className="text-emerald-600 dark:text-emerald-400 font-extrabold">92 pts</span>!
              </h3>
            ...
            <Link
              href="/bi"
              className="flex shrink-0 items-center gap-1.5 rounded-xl border border-cyan-500/30 bg-cyan-600 text-white dark:bg-cyan-500/10 dark:text-cyan-200 px-4 py-2.5 text-xs font-extrabold transition-all hover:bg-cyan-700 dark:hover:bg-cyan-500/20 dark:hover:text-white"
            >
