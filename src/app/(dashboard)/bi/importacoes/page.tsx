...
export default async function BiImportacoesPage() {
  ...
  const [biImports, produtividadeLogs, produtividadeInferred, metasImports, tarefasImports] = await Promise.all([
  ...
  const unifiedRows = [...biImports, ...produtividadeLogs, ...produtividadeInferredFiltered, ...metasImports, ...tarefasImports].sort((a, b) => {
