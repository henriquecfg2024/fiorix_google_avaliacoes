...
export async function logAuditEvent(params: {
  tenantId: string;
  usuarioId: string;
  tipo: "comunicado_view" | "comunicado_ciencia" | "holerite_view" | "holerite_print" | "holerite_download_authorized" | "ferias_view" | "lgpd_relatorio" | "lgpd_solicitacao_exclusao" | "ferias_previstas_update" | "comunicado_publish" | "comunicado_cancel" | "user_created" | "user_role_changed";
  recursoId?: string;
  ip?: string;
  userAgent?: string;
